...
export const useChatStore = create((set, get) => ({
  ...
  sendMessage: async (messageData) => {
    ...
    try {
      ...
      // remove optimistic message on failure (use get() for current state)
  ...
  subscribeToMessages: () => {
    ...
    socket.on("newMessage", (newMessage) => {
      ...
      // Mark the new message as read in the UI since the chat is open
      newMessage.read = true;
      set({ messages: [...currentMessages, newMessage] });

      // Tell the backend we read this message
    ...
    // Listen for when our sent messages are read by the other person
